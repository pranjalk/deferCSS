...
function loadCSS(wi) {
  const curriedLoadCSS = (href, before, media, attributes) => {
    // Arguments explained:
    ...
    const sheets = doc.styleSheets; // Set any of the provided attributes to the stylesheet DOM Element.
    ...
    const onloadcssdefined = cb => {
      ...
      let i = sheets.length; // eslint-disable-next-line no-plusplus
